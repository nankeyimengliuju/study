    ...
    modal.initNotice = function () {
        ...
        if($(".fui-topmenu").length > 0){
            $(".topmenu_tab").each(function(index,item){
                if(index == 0){
                    $(this).css({'border-color':'#ff5555','color':'#ff5555'});
            ...
            $('.tab').click(function(){
                $(this).prevAll().css({'border-color':'#fff','color':'#666666'});
                $(this).css({'border-color':'#ff5555','color':'#ff5555'});
                $(this).nextAll().css({'border-color':'#fff','color':'#666666'});
                var notskip = $(this).data('notskip')
                var url = $(this).data('url');
                modal.initTopmenu(notskip,url);
            })
        ...
        if($(".fui-tabbar").length > 0){
            ...
            $('.tab-a').click(function(){
                $(this).prevAll().css({'border-color':'#fff','color':'#666666'}).removeClass('active');
                $(this).css({'border-color':'#ff5555','color':'#ff5555'}).addClass('active');
                $(this).nextAll().css({'border-color':'#fff','color':'#666666'}).removeClass('active');
                var notskip = $(this).data('notskip')
                var url = $(this).data('url');
