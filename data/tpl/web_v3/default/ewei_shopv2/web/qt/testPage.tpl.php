...
<div class="page-header">当前位置：<span class="text-primary">留言列表</span></div>
...
<div class="page-content">
    ...
    <form action="./index.php" method="get" class="form-horizontal table-search" role="form">
        ...
        <input type="hidden" name="r" value="qt.index"/>
        ...
        <div class="col-md-12">
            ...
            <div class="page-table-header">
                ...
                <div class="btn-group">
                    ...
                    <?php if(cv('qt.delete.testdelete')) { ?>
                    ...
                    <button class="btn btn-default btn-sm btn-operation" type="button" data-toggle='batch-remove' data-confirm="确认要删除?" data-href="<?php  echo webUrl('qt/delete/testdelete')?>">
            ...
            <table class="table table-responsive">
                ...
                <tr>
                    ...
                    <th style="width: 100px; text-align: center">留言者</th>

                    <th style="" colspan="2">内容</th>
                ...
                <tr>
                    ...
                    <td colspan="2">
                        ...
                        <?php  if(empty($row['content'])) { ?>未留言<?php  } else { ?><?php  echo $row['content'];?><?php  } ?>
                    ...
                    <td style="overflow:visible;text-align: center;">
                        ...
                        <div class="btn-group">
                            ...
                            <a class="btn btn-op btn-operation" data-toggle='ajaxRemove' href="<?php  echo webUrl('qt/delete/testdelete',array('id' => $row['id']));?>" data-confirm="确定要删除该留言吗？">

                                             <span data-toggle="tooltip" data-placement="top" title="" data-original-title="删除留言">
                ...
                <tr>
                    ...
                    <td <?php  if($_GPC['groupid']) { ?>colspan="5"<?php  } ?>  style="text-align: right">
    ...
    <?php  } ?>
        ...
        $("#modal-change-btn").click(function () {
            ...
            tip.confirm("确定要将选中会员移动到 "+levelname+" 吗？", function () {
                ...
                $.post(biz.url('qt/delete/testdelete'),{
